    ...
    <>
        ...
        <main>
            ...
            <div className="experience-card">
                ...
                <ul>
                    <li>Designed and implemented multi-agent pathfinding algorithms and task allocation leveraging C++ and
                        OpenGL, optimizing robot sorting operations on a simulated grid.</li>
            ...
            <div className="experience-card">
                ...
                <ul>
                    ...
                    <li>Streamlined customer database updates operating adaptive learning algorithms, improving real-time
                        response accuracy by 30% and reducing query processing time by 15%.</li>
                    <li>Collaborated with investors to secure $25,000 in funding by presenting key product insights,
                        focusing on the scalability and impact on customer engagement.</li>
                </ul>
            </div>
            ...
            <div className="experience-card">
                ...
                <ul>
                    ...
                    <li>Directed in a 5-person team to integrate APIs and deploy scalable solutions for seamless
                        performance.</li>
                </ul>
            </div>
